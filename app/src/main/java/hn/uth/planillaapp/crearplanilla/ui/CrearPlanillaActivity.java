package hn.uth.planillaapp.crearplanilla.ui;
...
import hn.uth.planillaapp.databinding.ActivityCrearPlanillaBinding;
import hn.uth.planillaapp.listadoplanillas.entity.Planilla;
import hn.uth.planillaapp.listadoplanillas.ui.PlanillaViewModel;
...
public class CrearPlanillaActivity extends AppCompatActivity {
    ...
    private void obtenerDatosIntent(Intent intent) {
        ...
        if(concepto != null){
            ...
            String totals = intent.getStringExtra("PLANILLA_TOTAL");
            ...
            binding.tilTotals.getEditText().setText(totals);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == android.R.id.home){
            ...
            Planilla planillaEliminar = new Planilla(binding.tilConcepto.getEditText().getText().toString(),
                    binding.tilFecha.getEditText().getText().toString(),binding.tilTotals.getEditText().getText().toString());
